...
Se presentan los resultados de los análisis de clustering k-means aplicados a las variables numéricas de la base de datos utilizando 3 y 2 clusters, respectivamente.
...
- Recomendamos explorar otras técnicas de análisis y considerar factores adicionales para obtener una visión más completa.
